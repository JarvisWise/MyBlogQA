...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-6 text-center my-login">
            ...
            <form name="username" action="<c:url value='/edit/reset-password/${userToken}' />" method="POST">
                <div class="form-group  text-left">
                    <label for="newPassword">Password: </label>
                    <input type="password" value="" class="form-control" name="newPassword" required placeholder="Enter password" id="newPassword" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,16}$"/>
                </div>
                <div class="form-group  text-left">
                ...
                <!-- button -->
                <button type="submit" class="btn btn-block my text-left">Change Password</button>
                <a href="<c:out value="${loginURL}"/>" class="btn btn-block my">Cancel</a>
            </form>
        </div>
        <div class="col-sm-3 sidenav">
        </div>
